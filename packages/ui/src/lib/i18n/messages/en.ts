...
export const dict = {
  ...
  'chat.toolGroup.context.title.active': 'Exploring',
  'chat.toolGroup.context.title.done': 'Explored',
  'chat.toolGroup.context.title.failed': 'Exploration failed',
  'chat.toolGroup.context.summary.readSingle': '{count} read',
  'chat.toolGroup.context.summary.searchSingle': '{count} search',
  'chat.toolGroup.context.summary.listSingle': '{count} directory',
  'chat.toolGroup.context.summary.readPluralFew': '{count} reads',
  'chat.toolGroup.context.summary.readPluralMany': '{count} reads',
  'chat.toolGroup.context.summary.searchPluralFew': '{count} searches',
  'chat.toolGroup.context.summary.searchPluralMany': '{count} searches',
  'chat.toolGroup.context.summary.listPluralFew': '{count} directories',
  'chat.toolGroup.context.summary.listPluralMany': '{count} directories',
  'chat.toolGroup.context.child.active': 'Active',
  'chat.toolGroup.context.child.error': 'Error',
  'chat.toolGroup.context.child.read': 'Read',
  'chat.toolGroup.context.child.search': 'Search',
  'chat.toolGroup.context.child.list': 'List',
  'chat.toolGroup.context.actions.expandWithSummary': 'Expand context tool details: {summary}',
  'chat.toolGroup.context.actions.collapseWithSummary': 'Collapse context tool details: {summary}',
